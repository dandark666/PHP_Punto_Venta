   ...
   <section class="contenedor">
    ...
    <article class="content-art2">
        <table border="1" class="tablaCat">
            ...
            $consulta = "CALL ObtenerMarcas()";
            $areas = mysqli_query($conexion, $consulta);
            while($regMarca = mysqli_fetch_assoc($areas)){
                echo "<tr>".
                "<td data-label='NO.'>".$regMarca["idMarca"] . "</td>".
                "<td data-label='DESCRIPCION'>".$regMarca["descripcionmarca"] . "</td>".
                "<td data-label='ESTATUS'>".$regMarca["estatus"] . "</td>".
                "<td data-label='EDITAR'><a href='modificar-mar.php?id=".$regMarca["idMarca"]."' title='Editar'><img src='res/edit.png' width='30' height='30'></a></td>".
                "<td data-label='ELIMINAR'><a href='eliminar-mar.php?id=".$regMarca["idMarca"]."' title='Eliminar'><img src='res/elim.png' width='30' height='30'></a></td>".
                "</tr>";
            }
            ?>
        </table>
